...
def get_conversational_chain():
    ...
    Answer:
    """
    model = ChatGoogleGenerativeAI(model="models/gemini-1.5-pro", temperature=0.5)
...
def main():
    st.set_page_config(page_title="Script Wizard")
    ...
    if user_question:
        ...
        st.session_state.conversation.insert(0, (user_question, response))
